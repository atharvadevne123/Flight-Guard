...
fetch_task   = PythonOperator(task_id="fetch_flight_data_from_foundry",   python_callable=fetch_flight_data_from_foundry,   dag=dag)
risk_task    = PythonOperator(task_id="compute_carrier_risk_scores",       python_callable=compute_carrier_risk_scores,       dag=dag)
